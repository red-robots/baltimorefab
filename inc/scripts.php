...
function bellaworks_scripts() {
  ...
  wp_enqueue_style('bellaworks-style', get_stylesheet_directory_uri() .'/style.min.css', array(), '2.61' );
  ...
  wp_enqueue_script(
    'bellaworks-mCustomScrollbar',
    get_template_directory_uri() . '/assets/js/vendor/mCustomScrollbar.min.js',
    array(), '20260608', true
  );
